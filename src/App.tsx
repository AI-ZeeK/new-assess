...
function App() {
  ...
  return (
    ...
    >
      <div
        ref={cardRef}
        className={`bg-white flex min-h-screen lg:h-full justify-center gap-4 flex-col items-center lg:border lg:rounded-md lg:shadow-md w-full p-4 md:p-8 max-w-[80rem] relative ${
